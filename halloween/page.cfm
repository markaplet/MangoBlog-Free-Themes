...
<title><mango:Page><mango:PageProperty title /></mango:Page> | <mango:Blog title /></title>
	...
	<div id="header">
		...
		<div id="mainNavigation">
			<ul>
				...
				<mango:Pages>
					<mango:Page>
						<li<mango:PageProperty ifiscurrentpage> class="current"</mango:PageProperty>><a href="<mango:PageProperty link>" title="<mango:PageProperty title />">
...
<h1 id="<mango:PageProperty id />"><mango:PageProperty title /></h1>
...
<h2 id="commentsClosed">Comments now closed</h2>
</mango:PageProperty>
